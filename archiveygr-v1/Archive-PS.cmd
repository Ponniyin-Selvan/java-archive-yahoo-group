...
REM SET YAG_JDBC_URL=-Dyag_jdbc_url=jdbc:mysql://mysql.namo-namaha.net:3306/bsabha
REM SET YAG_GROUP_NAME=-Dyag_group_name=Brahmasabha
REM SET YAG_JDBC_USER_ID=-Djdbc_user_id=bsabha
REM SET YAG_JDBC_PWD=-Djdbc_pwd=bsabha1234

SET YAG_JDBC_URL=-Dyag_jdbc_url=jdbc:mysql://mysql.namo-namaha.net:3306/ygrp_ps
SET YAG_GROUP_NAME=-Dyag_group_name=ponniyinselvan
SET YAG_JDBC_USER_ID=-Djdbc_user_id=ygrp_ps
SET YAG_JDBC_PWD=-Djdbc_pwd=ygrp1234
...
java %YAG_JDBC_URL% %YAG_GROUP_NAME% %YAG_JDBC_USER_ID% %YAG_JDBC_PWD% -cp bin;etc;%YAG_CP% %YAG_PROXY% %YAG_CLASS% ps.archive ps12345 0 -1 1 8000

start http://www.ponniyinselvan.info/messages/updateArchive
