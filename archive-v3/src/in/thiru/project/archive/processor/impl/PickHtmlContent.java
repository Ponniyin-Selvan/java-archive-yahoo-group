...
public class PickHtmlContent extends AbstractMessageProcessor {
    ...
    public void processMessage(ArchiveMessage message,
        ...
        if (parts != null) {
            List<Part> contentParts = parts.get("text/html");
            details.put("content.type", "text/html");
            if (contentParts == null) {
                contentParts = parts.get("text/plain"); // fallback to plain text
                details.put("content.type", "text/plain");
            }
